...
// Client defines the named pipe client interface to the privileged helper.
// This interface is shared across Windows and non-Windows builds.
//
// Design: The helper runs as a separate elevated process spawned via UAC,
// communicating over a named pipe using JSON messages.
